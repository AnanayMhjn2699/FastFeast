In this project I have used Swiggy's live API, because of which it sometimes does not show restaurant list therefore have added the screenshots of app in the Pictures folder.
